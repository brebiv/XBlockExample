...
class MyXBlock(XBlock):
    ...
    title = String(default="Title Click to get more info", scope=Scope.user_state_summary, help="Title of the block")
    content = String(default="Content goes here", scope=Scope.user_state_summary, help="Content inside the block")
